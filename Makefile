# This Makefile is for the oEdtk extension to perl.
#
...
#     NAME => q[oEdtk]
#     PREREQ_PM => { Spreadsheet::WriteExcel=>q[1] }
#     VERSION_FROM => q[lib/oEdtk/prodEdtk.pm]
#     dist => { COMPRESS=>q[gzip -9], SUFFIX=>q[tar.gz] }
...
TO_INST_PM = lib/.DS_Store \
	lib/oEdtk/chaineLib.pm \
	lib/oEdtk/dataEdtk.pm \
	lib/oEdtk/logger.pm \
	lib/oEdtk/objData.pm \
	lib/oEdtk/prodEdtk.pm \
	lib/oEdtk/prodEdtkXls.pm

PM_TO_BLIB = lib/oEdtk/dataEdtk.pm \
	blib/lib/oEdtk/dataEdtk.pm \
	lib/oEdtk/prodEdtk.pm \
	blib/lib/oEdtk/prodEdtk.pm \
	lib/oEdtk/objData.pm \
	blib/lib/oEdtk/objData.pm \
	lib/oEdtk/logger.pm \
	blib/lib/oEdtk/logger.pm \
	lib/oEdtk/prodEdtkXls.pm \
	blib/lib/oEdtk/prodEdtkXls.pm \
	lib/oEdtk/chaineLib.pm \
	blib/lib/oEdtk/chaineLib.pm \
	lib/.DS_Store \
	blib/lib/.DS_Store
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/oEdtk/dataEdtk.pm blib/lib/oEdtk/objData.pm blib/lib/oEdtk/chaineLib.pm $(MAKEFILE_OLD) blib/lib/oEdtk/prodEdtk.pm blib/lib/.DS_Store blib/lib/oEdtk/logger.pm blib/lib/oEdtk/prodEdtkXls.pm
	$(RM_F) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         oEdtk' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.31' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/oEdtk/prodEdtk.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    Spreadsheet::WriteExcel:       1' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Spreadsheet-WriteExcel" VERSION="1,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/oEdtk/dataEdtk.pm blib/lib/oEdtk/dataEdtk.pm \
	  lib/oEdtk/prodEdtk.pm blib/lib/oEdtk/prodEdtk.pm \
	  lib/oEdtk/objData.pm blib/lib/oEdtk/objData.pm \
	  lib/oEdtk/logger.pm blib/lib/oEdtk/logger.pm \
	  lib/oEdtk/prodEdtkXls.pm blib/lib/oEdtk/prodEdtkXls.pm \
	  lib/oEdtk/chaineLib.pm blib/lib/oEdtk/chaineLib.pm \
